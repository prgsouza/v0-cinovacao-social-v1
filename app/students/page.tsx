...
const students = [
  {
    ...
    age: 8,
    community: "Vila Nova",
    photo: "/young-girl-smiling.png",
    canGoAlone: false,
    guardian: "Maria Silva",
    phone: "(11) 99999-1111",
    observations: "Alergia a amendoim",
  },
  {
    id: 2,
    name: "João Santos",
  ...
  },
  {
    ...
    photo: "/young-girl-curly-hair.png",
    canGoAlone: false,
    guardian: "Ana Costa",
    phone: "(11) 99999-3333",
    observations: "Toma medicamento para asma",
  },
  {
    id: 4,
    name: "Carlos Lima",
    age: 7,
    community: "Vila Nova",
    photo: "/placeholder-rr5c2.png",
    canGoAlone: false,
    guardian: "José Lima",
    phone: "(11) 99999-4444",
    observations: "Usa óculos",
  },
]
            ...
            <DialogContent className="sm:max-w-[500px]">
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="grid gap-2">
                  ...
                  <Input id="spots" type="number" placeholder="Número de vagas" />
                </div>
                <div className="grid gap-2">
                  <Label htmlFor="activity-description">Descrição</Label>
                  <Textarea id="activity-description" placeholder="Detalhes sobre a atividade" />
                </div>
                <div className="grid gap-2">
                  <Label htmlFor="activity-photo">Foto da Atividade</Label>
                  <div className="flex items-center gap-2">
                    <Input id="activity-photo" type="file" accept="image/*" />
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button className="bg-[#88957d] hover:bg-[#7f6e62]" onClick={handleAddActivity}>
                  Criar Atividade
                </Button>
              </div>
            </DialogContent>
          ...
          <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-y-auto">
            ...
            <div className="grid gap-4 py-4">
              <div className="grid gap-2">
                ...
                <Input id="student-name" placeholder="Nome completo do aluno" />
              </div>
              <div className="grid gap-2">
                <Label htmlFor="community">Qual comunidade pertence?</Label>
                <Input id="community" placeholder="Nome da comunidade" />
              </div>
              <div className="grid gap-2">
              ...
              <div className="grid gap-2">
                ...
                <Input id="age" type="number" placeholder="Idade do aluno" />
              </div>
              <div className="flex items-center space-x-2">
                <Checkbox id="can-go-alone" />
                <Label htmlFor="can-go-alone">Pode voltar sozinho?</Label>
              </div>
              <div className="grid gap-2">
                <Label htmlFor="observations">Observações</Label>
                <Textarea id="observations" placeholder="Restrições alimentares, alergias, medicamentos, etc." />
              </div>
              <div className="border-t pt-4">
                ...
                <div className="grid gap-4">
                  <div className="grid gap-2">
                    ...
                    <Input id="guardian-name" placeholder="Nome do responsável" />
                  </div>
                  <div className="grid gap-2">
                    <Label htmlFor="guardian-phone">Telefone de Contato</Label>
                    <Input id="guardian-phone" placeholder="(11) 99999-9999" />
                  </div>
                </div>
              </div>
            </div>
            <div className="flex justify-end gap-2">
              ...
              <Button className="bg-[#88957d] hover:bg-[#7f6e62]" onClick={handleAddStudent}>
                Cadastrar Aluno
              </Button>
            </div>
          </DialogContent>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <Badge variant={student.canGoAlone ? "default" : "secondary"} className="mt-1">
                    {student.canGoAlone ? "Independente" : "Acompanhado"}
                  </Badge>
                </div>
              </div>
            </CardContent>
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">{selectedStudent.canGoAlone ? "Sim" : "Não"}</p>
                </div>
                <div>
                  <Label className="font-medium">Responsável</Label>
                  <p className="text-sm text-gray-600">{selectedStudent.guardian}</p>
                </div>
                <div>
