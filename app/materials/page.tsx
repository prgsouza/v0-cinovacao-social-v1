...
export default function MaterialsPage() {
  ...
  const handleStockAdjustment = async (
    ...
    try {
      ...
      console.log("[v0] Atualizando estoque:", {
        materialId,
        action,
        newQuantity,
      });
  ...
  const handleEditLend = async (formData: FormData) => {
    ...
    try {
      ...
      console.log("[v0] Editando empréstimo:", {
        id: selectedLend.id,
        updates,
      });
      ...
      setLends(
        lends.map((lend) => (lend.id === selectedLend.id ? updated : lend))
      );
    ...
    <PageContainer>
      ...
      <div className="container mx-auto px-4 py-8">
        <Tabs defaultValue="materials" className="w-full">
          <TabsList className="grid w-full grid-cols-2 mb-8 bg-white/90 backdrop-blur-sm">
            <TabsTrigger
              value="materials"
              className="data-[state=active]:bg-[#88957d] data-[state=active]:text-white"
            >
              Materiais
            </TabsTrigger>
            <TabsTrigger
              value="lends"
              className="data-[state=active]:bg-[#d09c91] data-[state=active]:text-white"
            >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {editingQuantity === material.id ? (
                          <Input
                            ...
                            autoFocus
                            onBlur={(e) =>
                              handleQuantityEdit(material.id, e.target.value)
                            }
                            onKeyDown={(e) => {
                              if (e.key === "Enter") {
                                handleQuantityEdit(
              ...
              <div className="flex gap-4 overflow-x-auto pb-4">
                {lends
                  ...
                  .map((lend) => (
                    <Card
                      key={lend.id}
                      className="min-w-[300px] bg-orange-50 border-orange-200"
                    >
                      <CardContent className="p-4">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <Badge variant="destructive">
                            {Math.floor(
                              Math.abs(
                                new Date(lend.due_date).getTime() -
                                  new Date().getTime()
                              ) /
                                (1000 * 60 * 60 * 24)
                            )}{" "}
              ...
              <div className="flex gap-2 flex-1 max-w-md">
                ...
                <div className="relative">
                  <Button
                    variant="outline"
                    onClick={() =>
                      setShowLendsCategoryFilter(!showLendsCategoryFilter)
                    }
                    className="flex items-center gap-2"
                  >
                    <Filter className="w-4 h-4" />
                  ...
                  >
                    <div className="grid gap-4 py-4">
                      ...
                      <div className="grid gap-2">
                        ...
                        <Input
                          name="borrower"
                          placeholder="Nome de quem pegou o item"
                          required
                        />
                      </div>
                      <div className="grid gap-2">
                    ...
                    <div className="flex justify-end gap-2">
                      ...
                      <Button
                        type="submit"
                        className="bg-[#d09c91] hover:bg-[#7f6e62]"
                      >
                        Cadastrar
                      </Button>
                    </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {filteredLends.map((lend) => (
                  ...
                  >
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between mb-2">
                        <h4 className="font-semibold text-[#7f6e62] text-sm">
                          {lend.item_name}
                        </h4>
      ...
      >
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle>
              {isEditingLend ? "Editar Empréstimo" : "Detalhes do Empréstimo"}
            </DialogTitle>
          </DialogHeader>
          {selectedLend && (
            <div className="grid gap-4 py-4">
                ...
                >
                  <div className="grid gap-4">
                    <div className="grid gap-2">
                      ...
                      <Input
                        name="edit-borrower"
                        defaultValue={selectedLend.borrower}
                        required
                      />
                    </div>
                    <div className="grid gap-2">
                      ...
                      <Input
                        name="edit-due-date"
                        type="date"
                        defaultValue={selectedLend.due_date}
                        required
                      />
                    </div>
                    <div className="grid gap-2">
                      ...
                      <Textarea
                        ...
                        defaultValue={selectedLend.description}
                      />
                    </div>
                    <div className="grid gap-2">
                      <Label htmlFor="edit-authorized-by">Autorizado por</Label>
                      <Input
                        name="edit-authorized-by"
                        defaultValue={selectedLend.authorized_by}
                        required
                      />
                    </div>
                    <div className="grid gap-2">
                      ...
                      <Input
                        ...
                        defaultValue={selectedLend.delivered_by}
                        required
                      />
                    </div>
                    <div className="flex gap-2 mt-4">
                      ...
                      <Button
                        type="submit"
                        className="flex-1 bg-[#d09c91] hover:bg-[#7f6e62]"
                      >
                        Salvar
                      </Button>
                    </div>
